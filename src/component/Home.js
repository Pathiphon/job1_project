...
export default function Home() {
    return (
        <div className="App w-100 well2" style={{ backgroundImage: `url(${bg13})`}} >
            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active ">
                        <img loading="lazy" className="d-block img_silder container" src={logo1} alt="First slide" />
                    </div>
                    <div className="carousel-item">
                        <img loading="lazy" className="d-block img_silder container" src={logo2} alt="Second slide" />
                    </div>
                    <div className="carousel-item">
                        <img loading="lazy" className="d-block img_silder container" src={logo3} alt="Third slide" />
                    </div>
                </div>
            ...
            <div className="w-100 pt-3" style={{ backgroundImage: `url(${bg9})`, backgroundSize: "100%" }}>
                ...
                <div className="text-center pt-2 ">
                    <img loading="lazy" src={casino1} className="rounded img_max" />
                </div>
            </div>
            <div style={{ backgroundImage: `url(${bg2})`, backgroundSize: "100%" }}>
                ...
                <div className="text-center pt-2 " style={{ position: "relative" }}>
                    <img loading="lazy" src={demo1} className="rounded w-100" />
                    <a target="_blank" href='https://igt.sa-api5.net/h5web/index.html?username=mm88bet_demo&token=519D6F7367EA3D7A8991E3673E08D60C&lang=th&lobby=a232&returnurl=https://mm88bet.com/&net=0&h5web=True&ui=1&options=&bannerURL=https://mm88bet.com/wp-content/uploads/2020/09/bannerload-sa.jpg'>
                        <img loading="lazy" src={button1} className="in_img" />
                    </a>
                </div>
            </div>
